...
with sync_playwright() as p:
    ...
    # Dump a large chunk of page HTML to understand structure
    html = page.content()
    # Find the section with race form/history
    # Look for "Going" as column header
    going_idx = html.lower().find("going")
    if going_idx >= 0:
        print(f"\n[Found 'Going' at index {going_idx}]")
        print("Context around 'Going':")
        print(html[max(0, going_idx-500):going_idx+2000])
    else:
        print("\n[No 'Going' found in HTML]")
