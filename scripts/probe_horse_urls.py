...
with sync_playwright() as p:
    ...
    time.sleep(3)
    print(f"Homepage: {page.title()!r}")

    # Try to find horse profile URLs by trying different formats
    tests = [
        "https://www.attheraces.com/horse/belinus",
        "https://www.attheraces.com/horses/belinus", 
        "https://www.attheraces.com/form/guide/horse/belinus",
        "https://www.attheraces.com/racecard/horse/belinus",
        "https://www.attheraces.com/guide/horse/belinus",
        "https://www.attheraces.com/stats/horse/belinus",
    ]
    for url in tests:
        try:
            ...
            title = page.title()
            final = page.url
            print(f"  [{status}] {url} -> {title!r} final={final!r}")
            time.sleep(2)
